...
parser.add_argument('--Function', type=str, help='Choosing base or HR', default="HR")  # default = "base"
...
parser.add_argument("--hyperlipsbase_video_root", help="Root folder of the videos generated by hyper_base",
                    default="hyperlips_base_results")   # default = "results"
...
def data_process_hyper_hq_module(args):
    ...
    for i in tqdm(range(len(filelist_new))):
        ...
        vfile_o = path.join(args.hyperlips_train_dataset, "video_clips", "datasets", (args.origin_data_root.split("/")[-1]),     ######## 此处修改了路径 ########
                            vidname + ".mp4")
